...
# ======================================================================
# MetaForge Tool Hub: Settings (V.Core - Build 5.3.21)
# Primary Role: Router / Dispatcher (Directive IV.3)
# Physical Location: \tools\settings\settings.py
# Build 5.3.21: Registered commit_update for state synchronization.
# ======================================================================
import sys
import json
...
def run_logic(action, tools_dir, env_path):
    ...
    # H. Update Engine (GitHub Manifest Comparison & Sync)
    if action == "check_updates":
        return update_engine.check_for_updates()
    if action == "commit_update":
        return update_engine.commit_update()
