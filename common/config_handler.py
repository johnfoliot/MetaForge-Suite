...
# Build 5.3.3: Explicitly exposed DISCOGS_TOKEN for cloud fetch support.
# ======================================================================
import os
import sys
...
DEPLOY_DIR = PROJECT_ROOT / "deploy" # Deployment and Update metadata
...
# --- SYSTEM FILES ---
UPDATE_MANIFEST = DEPLOY_DIR / "updates.json"
...
DISCOGS_TOKEN = os.getenv("DISCOGS_TOKEN") # Added in Build 5.3.3
...
def check_system():
    ...
    print(f"   Discogs Token: {'✅ Configured' if DISCOGS_TOKEN else '❌ Missing'}")
