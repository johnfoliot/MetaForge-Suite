...
def initialize_database():
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS tracks (file_path TEXT PRIMARY KEY, mf_id TEXT, mf_artist_id TEXT, mb_artist_id TEXT, mb_track_id TEXT, acoustid TEXT, title TEXT, genre TEXT, sub_genre TEXT, original_year INTEGER, bpm INTEGER, key_val TEXT, mood TEXT, intensity INTEGER, is_remediated INTEGER, last_updated TIMESTAMP, mb_work_id TEXT, mf_artist_id TEXT, leak_flag INTEGER)")
    cursor.execute("""
