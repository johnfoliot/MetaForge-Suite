...
REM BFCPEEXE=D:\MetaForge Suite\MetaForge.exe
REM BFCPEICON=D:\MetaForge Suite\MetaForge.ico
...
REM BFCPEVERPRODUCT=MetaForge Suite
REM BFCPEVERDESC=MetaForge Suite
...
REM BFCPEWTITLE=MetaForge Suite
REM BFCPEOPTIONEND
@echo off
